...
/**
 * @description 获取系统信息
 * @link 获取系统信息 https://uniapp.dcloud.io/api/system/info
 */
export function sys() {
	try {
		// 优先使用新API
		...
		console.warn('新版API不可用，使用getSystemInfoSync降级')
...
export function getWindowInfo() {
	try {
		...
		// 降级处理，如果新API不可用，使用旧API
		console.warn('getWindowInfo不可用，使用getSystemInfoSync降级')
		return uni.getSystemInfoSync()
	}
}
export function getDeviceInfo() {
	try {
		...
		// 降级处理，如果新API不可用，使用旧API
		console.warn('getDeviceInfo不可用，使用getSystemInfoSync降级')
		return uni.getSystemInfoSync()
	}
}
