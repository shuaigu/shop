...
function getLocaleLanguage$1() {
  let localeLanguage = "";
  {
    localeLanguage = normalizeLocale(ks.getSystemInfoSync().language) || LOCALE_EN;
  }
...
function checkDeviceWidth() {
  ...
  {
    const { windowWidth: w2, pixelRatio: p2, platform: pf } = getBaseSystemInfo();
    windowWidth = w2;
    pixelRatio = p2;
    platform = pf;
  }
...
let deviceId;
function useDeviceId(global2 = ks) {
...
const offError = {
  args(fromArgs) {
    ...
    if (!app.$vm) {
      ...
      const index2 = ks.$onErrorHandlers.findIndex((fn) => fn === fromArgs);
      if (index2 !== -1) {
        ks.$onErrorHandlers.splice(index2, 1);
      }
...
function initUni(api, protocols2, platform = ks) {
...
function nextSetDataTick(mpInstance, fn) {
  {
    mpInstance.setData({ r1: 1 }, () => nextTick$1(() => fn()));
  }
}
...
function callHook(name, args) {
  ...
  {
    if (name === "onLoad" && args && args.__id__ && isFunction(ks.getEventChannel)) {
...
ks.createSubpackageApp = global.createSubpackageApp = createSubpackageApp;
var isVue2 = false;
...
const pages = [
  ...
  {
    path: "pages/userArticleList/userArticleList",
    style: {
...
const b = true, E = "mp-kuaishou", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.31.133"],"servePort":7001,"debugPort":9001,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/软件/HBuilderX/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"aly-2","spaceId":"mp-4f80f767-c485-40d3-b143-9134b266a903","clientSecret":"Ob5LoJeG66OrmkXfG3NLNA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__EF9E83E";
} catch (e2) {
...
Kn = class {
  constructor() {
    throw nn({ message: `Platform ${P} is not supported by secure network` });
  }
};
...
function Gs(e2) {
  const n2 = { getAppBaseInfo: index.getSystemInfo, getPushClientId: index.getPushClientId };
  return function(s2) {
