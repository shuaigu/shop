...
const b = true, E = "mp-kuaishou", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.0.22"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/软件/HBuilderX/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"aly-2","spaceId":"mp-4f80f767-c485-40d3-b143-9134b266a903","clientSecret":"Ob5LoJeG66OrmkXfG3NLNA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__EF9E83E";
} catch (e2) {
