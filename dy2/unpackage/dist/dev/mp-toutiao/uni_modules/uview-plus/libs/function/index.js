...
function sys() {
  try {
    ...
    common_vendor.index.__f__("warn", "at uni_modules/uview-plus/libs/function/index.js:84", "新版API不可用，使用getSystemInfoSync降级");
...
function getWindowInfo() {
  try {
    ...
    common_vendor.index.__f__("warn", "at uni_modules/uview-plus/libs/function/index.js:94", "getWindowInfo不可用，使用getSystemInfoSync降级");
    return common_vendor.index.getSystemInfoSync();
  }
}
...
function error(err) {
  {
    common_vendor.index.__f__("error", "at uni_modules/uview-plus/libs/function/index.js:325", `uView提示：${err}`);
  }
}
...
exports.sleep = sleep;
//# sourceMappingURL=../../../../../.sourcemap/mp-toutiao/uni_modules/uview-plus/libs/function/index.js.map
