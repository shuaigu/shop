  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const getCategoryName = async (cateId) => {
      try {
        ...
        common_vendor.index.__f__("error", "at components/tuijian/tuijian.vue:99", "获取分类名称失败:", err);
        return "未分类";
      }
    };
    const getCategoryImage = async (cateId) => {
      try {
        ...
        common_vendor.index.__f__("error", "at components/tuijian/tuijian.vue:111", "获取分类图片失败:", err);
        return "/static/images/default-image.png";
      }
    };
    const getMoreArticles = async (refresh = false) => {
      try {
        ...
        common_vendor.index.__f__("error", "at components/tuijian/tuijian.vue:172", "获取更多文章失败:", err);
        loadMoreStatus.value = "more";
      } finally {
    ...
    const handleImagePreview = (images) => {
      ...
      common_vendor.index.previewImage({
        ...
        loop: true,
        fail: (err) => {
          common_vendor.index.__f__("error", "at components/tuijian/tuijian.vue:205", "预览图片失败:", err);
...
//# sourceMappingURL=../../../.sourcemap/mp-toutiao/components/tuijian/tuijian.js.map
