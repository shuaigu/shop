...
function initRuntimeSocketService() {
  const hosts = "192.168.31.131,127.0.0.1";
  const port = "8090";
  const id2 = "mp-toutiao_m017L5";
...
const pages = [
  ...
  {
    path: "pages/video-preview/video-preview",
    style: {
...
const subPackages = [
  {
    ...
    pages: [
      ...
      {
        path: "userInfoQuery/userInfoQuery",
        style: {
          navigationBarTitleText: "用户信息查询"
        }
      },
      {
      ...
      {
        path: "userRoleManage/userRoleManage",
        style: {
          navigationBarTitleText: "角色管理"
        }
      },
      {
        path: "qiniuyun/qiniuyun",
        style: {
          navigationBarTitleText: ""
        }
      },
      {
        path: "subChoujiang/subChoujiang",
        style: {
          navigationBarTitleText: ""
        }
      }
...
const S = true, b = "mp-toutiao", T = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), A = b, P = I('{"address":["127.0.0.1","192.168.31.131"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/代码测试/HBuilderX.4.45.2025010502/HBuilderX/plugins/unicloud/**/*.js"]}'), C = I('[{"provider":"aliyun","spaceName":"aly-2","spaceId":"mp-4f80f767-c485-40d3-b143-9134b266a903","clientSecret":"Ob5LoJeG66OrmkXfG3NLNA==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__EF9E83E";
} catch (e2) {
