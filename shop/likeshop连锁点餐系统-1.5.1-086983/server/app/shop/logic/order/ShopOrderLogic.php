...
class ShopOrderLogic extends Logic
{
    ...
    public static function lists($get, $shop_id)
    {
        ...
        $field = 'o.id,o.user_id,o.order_sn,o.order_status,o.create_time,o.total_num,o.dining_type,o.is_appoint,o.appoint_time,o.take_code,o.consignee,o.mobile,o.delivery_amount,(o.order_amount - o.delivery_amount) as goods_amount,o.order_amount,o.pay_way,o.pay_status,o.pay_time,o.order_type,o.refund_amount,o.surplus_refund_amount,o.refund_status,o.refund_time,o.shop_desk_id,o.transaction_id';
        ...
        $lists = Order::alias('o')
            ...
            ->where($where)
            ->append(['order_status_text','pay_way_text','pay_status_text','dining_type_text','refund_status_desc','shop_desk'])
    ...
    public static function print($post)
    {
        try {
            ...
            //打印机列表
            $printer_list = Printer::with(['printer_template'])->where(['printer_config_id' => $printer_config['id'], 'del' => 0,'status'=>1,'shop_id'=>$post['shop_id']])->select();
