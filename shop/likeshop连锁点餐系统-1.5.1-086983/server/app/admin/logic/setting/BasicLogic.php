...
class BasicLogic extends Logic
{
    ...
    public static function getBasicConfig()
    {
        $config = [
            ...
            'clarity_app_id'    => ConfigServer::get('website', 'clarity_app_id'),
    ...
    public static function setWebsiteBasic($post)
    {
        ...
        ConfigServer::set('website', 'clarity_app_id', UrlServer::setFileUrl($post['clarity_app_id'] ?? ''));
    }
     ...
     * @date 2023/10/8 17:36
     */
    public static function setPolicy(array $post)
    {
