...
class ShopOrderLogic extends Logic
{
    ...
    public static function lists($get = [])
    {
        ...
        $field = 'o.id,o.user_id,o.order_sn,o.order_status,o.create_time,o.total_num,o.dining_type,o.is_appoint,o.appoint_time,o.take_code,o.consignee,o.mobile,o.delivery_amount,(o.order_amount - o.delivery_amount) as goods_amount,o.order_amount,o.pay_way,o.pay_status,o.pay_time,o.order_type,o.refund_amount,o.surplus_refund_amount,o.refund_status,o.refund_time,s.shop_sn,s.name as shop_name,o.shop_desk_id,o.transaction_id';
