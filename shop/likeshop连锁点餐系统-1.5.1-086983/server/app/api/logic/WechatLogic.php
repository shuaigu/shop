...
class WechatLogic extends Logic
{
    ...
    public static function jsConfig($url)
    {
        ...
        $apis = ['onMenuShareTimeline', 'onMenuShareAppMessage', 'onMenuShareQQ', 'onMenuShareWeibo', 'onMenuShareQZone', 'openLocation', 'getLocation', 'chooseWXPay', 'updateAppMessageShareData', 'updateTimelineShareData', 'openAddress','scanQRCode'];
        try {
            $data = $app->jssdk->getConfigArray($apis, true, $beta = false);
