...
class NoticeEnum
{
    ...
    const REGISTER_NOTICE       = 101;        //验证码注册通知
    const RESETPASSWORD_NOTICE  = 102;        //重置密码通知
    const LOGIN_NOTICE          = 103;        //验证码登录通知

    const CHANGEMOBILE_NOTICE   = 104;        //变更新手机号码验证码通知

    const BINDMOBILE_NOTICE     = 105;        //绑定手机号码验证码通知
...
//        self::TAKEOUT_NOTICE,
    ...
    const NOTICE_NEED_CODE = [
        ...
        self::RESETPASSWORD_NOTICE,
        self::LOGIN_NOTICE,
        self::CHANGEMOBILE_NOTICE,
        self::BINDMOBILE_NOTICE,
    ];
    //通知门店
    ...
    const SMS_SCENE = [
        ...
        'ZCTZ'      => self::REGISTER_NOTICE,        //注册通知
        'WJMM'      => self::RESETPASSWORD_NOTICE,   //忘记密码
        'YZMDL'     => self::LOGIN_NOTICE,           //验证码登录
        'BGSJHM'    => self::CHANGEMOBILE_NOTICE,    //变更手机号码
        'BDSJHM'    => self::BINDMOBILE_NOTICE,      //绑定手机号码
    ];
    ...
    public static function getSceneDesc($state)
    {
        $data = [
            ...
            self::REGISTER_NOTICE       => '注册验证码',
            self::RESETPASSWORD_NOTICE  => '重置密码验证码',
            self::LOGIN_NOTICE          => '验证码登录',
            self::CHANGEMOBILE_NOTICE   => '变更手机号码验证码',
            self::BINDMOBILE_NOTICE     => '绑定手机号码验证码',
            //商家
