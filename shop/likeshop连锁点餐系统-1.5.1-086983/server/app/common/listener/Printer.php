...
class Printer
{
    ...
    public function handle($params)
    {
        try{
            ...
            //打印机列表
            $printer_list = \app\common\model\Printer::with(['printer_template'])->where(['printer_config_id' => $printer_config['id'], 'del' => 0,'status'=>1,'auto_print'=>1,'shop_id'=>$order['shop_id']])->select();
